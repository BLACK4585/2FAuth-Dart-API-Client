...
class Model2FAccountExport {
  ...
  Model2FAccountExport({
    ...
    this.secret,
    this.digits,
    this.algorithm = Model2FAccountExportAlgorithmEnum.sha1,
    this.period = 30,
    this.counter = 0,
  ...
  static Model2FAccountExport? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Model2FAccountExport(
        ...
        otpType: Model2FAccountExportOtpTypeEnum.fromJson(json[r'otp_type']),
        secret: mapValueOfType<Object>(json, r'secret'),
        digits: mapValueOfType<Object>(json, r'digits'),
        algorithm: Model2FAccountExportAlgorithmEnum.fromJson(json[r'algorithm']) ?? Model2FAccountExportAlgorithmEnum.sha1,
